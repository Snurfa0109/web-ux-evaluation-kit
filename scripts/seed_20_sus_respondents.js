...
async function main() {
  console.log('🔄 Seeding 20 human-like SUS respondents...')
  ...
  for (let i = 0; i < RESPONDENTS_DATA.length; i++) {
    ...
    console.log(`[OK] [${item.code}] ${item.name} (${item.wa}) — SUS Score: ${susScore.toFixed(1)} [Jam: ${item.hour}:${item.min}]`)
  }

  console.log('🎉 Successfully seeded 20 human-like SUS respondents!')
}
